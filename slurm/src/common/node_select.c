			     ...
			     bitstr_t *exc_core_bitmap)
{
   ...
   // printf("cao: common/node_select.c, int select_g_job_test(), starting, line 590\n");
	if (slurm_select_init(0) < 0)
   {
      // printf("cao: common/node_select.c, int select_g_job_test(), return SLURM_ERROR, line 593\n");
		return SLURM_ERROR;
   }

   // printf("cao: common/node_select.c, int select_g_job_test(), return (*(ops[select_context_default].job_test)), line 597\n");
