 ...
 */
int slurm_submit_batch_job (job_desc_msg_t *req, submit_response_msg_t **resp)
{
   // printf("cao:  src/api/submit.c: int slurm_submit_batch_job() line 67\n");
        int rc;
        slurm_msg_t req_msg;
	...
	req_msg.data     = req;
   // printf("cao:  src/api/submit.c: int slurm_submit_batch_job () starting the slurm_submit_batch_job\n");
	rc = slurm_send_recv_controller_msg(&req_msg, &resp_msg);
   // printf("cao:  src/api/submit.c: int slurm_submit_batch_job () slurm_send_recv_controller_msg(&req_msg, &resp_msg), return value = %i\n", rc);
   ...
   // printf("cao:  src/api/submit.c: int slurm_submit_batch_job (), return SLURM_PROTOCOL_SUCCESS = %i\n", SLURM_PROTOCOL_SUCCESS);
